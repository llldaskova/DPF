...
namespace dpf
{
    public class DPF
    {
        public static ComplexNumber[] DirectDPF (ComplexNumber[] Array)
        {
            int C = 0;
        ...
        public static ComplexNumber[] ReverseDirectDPF(ComplexNumber[] Array)
        {
            int C = 0;
            ComplexNumber[] resultArray = new ComplexNumber[Array.Length];
            for (int i = 0; i < resultArray.Length; i++)
        ...
        public static ComplexNumber[] HFDPF (ComplexNumber[] Array)
        {
            int p1=0, p2=0;
            int C = 0;
        ...
        public static ComplexNumber[] ReverseHFDPF(ComplexNumber[] Array)
        {
            int p1 = 0, p2 = 0;
            int C = 0;
            for (int i = (int)Math.Ceiling(Math.Sqrt(Array.Length)); i > 0; i--)
